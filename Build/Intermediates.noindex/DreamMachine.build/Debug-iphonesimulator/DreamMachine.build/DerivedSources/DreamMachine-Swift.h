...
SWIFT_MODULE_NAMESPACE_PUSH("DreamMachine")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC12DreamMachine11AppDelegate")
...
@interface Image (SWIFT_EXTENSION(DreamMachine))
...
@interface Item (SWIFT_EXTENSION(DreamMachine))
...
SWIFT_CLASS("_TtC12DreamMachine8ItemCell")
...
@interface ItemType (SWIFT_EXTENSION(DreamMachine))
...
SWIFT_CLASS("_TtC12DreamMachine6MainVC")
...
@interface Store (SWIFT_EXTENSION(DreamMachine))
...
@interface UIView (SWIFT_EXTENSION(DreamMachine))
